...
app.layout = dbc.Container(
    [
        ...
        dcc.Store(id="highlighted-run-id", data=run_data.iloc[0]["run_id"]),
    ],
    fluid=True,
)
...
def highlight_table_row(active_cell, table_data):
    if not active_cell or not table_data:
        return dash.no_update, dash.no_update

    row_index = active_cell["row"]
    highlighted_run_id = table_data[row_index]["run_id"]
